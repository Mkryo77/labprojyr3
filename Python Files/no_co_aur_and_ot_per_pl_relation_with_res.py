...
av_mag_list2 = np.loadtxt("optimised_params_two_harms_no_co_aur_or_ot_per.txt", skiprows = 1, usecols=3)
periods_list2 = np.loadtxt("optimised_params_two_harms_no_co_aur_or_ot_per.txt", skiprows = 1, usecols=2)
dist_list = np.loadtxt("abs_mag_vs_para_dist_two_harm_no_co_aur_or_ot_per.txt", skiprows = 1, usecols=2)

dist_err_list = np.loadtxt("abs_mag_vs_para_dist_two_harm_no_co_aur_or_ot_per.txt", skiprows = 1, usecols=4)
av_mag_err_list2 = np.loadtxt("optimised_params_two_harms_no_co_aur_or_ot_per.txt", skiprows = 1, usecols=9)
periods_err_list2 = np.loadtxt("optimised_params_two_harms_no_co_aur_or_ot_per.txt", skiprows = 1, usecols=8)
...
axs[0].plot(log_periods2, linear(log_periods2, *popt))
...
plt.savefig("Abs Mag vs Log Period (No co_aur and ot_per).png", bbox_inches = 'tight', dpi = 1000)
plt.show()