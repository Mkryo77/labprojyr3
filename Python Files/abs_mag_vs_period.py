...
av_mag_list2 = np.loadtxt("abs_mag_vs_para_dist_two_harm.txt", skiprows = 1, usecols=1)
periods_list2 = np.loadtxt("abs_mag_vs_para_dist_two_harm.txt", skiprows = 1, usecols=3)



nstars = len(av_mag_list)
abs_mag_list = []
abs_mag_list2 = []
