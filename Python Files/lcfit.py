...
## data file:
#data = ascii.read('benresults.txt')
data = ascii.read('sz_cyg.txt')
P0 = 15.10964

### constants ###
pi = math.pi
err_mag_lim = 0.02  # magnitude error lower limit

### read data ###
time = np.array(data['col2'])
mag  = np.array(data['col7'])
err  = np.array(data['col8'])
